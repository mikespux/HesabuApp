...
public class AddBuy extends DashBoardActivity implements OnItemSelectedListener {
	private Spinner spinnerAccounts,SpinQunt;
	private TextView textTransDate,not;
	private int day, month, year;
	private final int DATE_DIALOG = 1;
	EditText editTransAmount,editChequeNo,editChequeParty,InStock;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.add_buy);
		 setHeader(getString(R.string.Buy), true, true);
		 prgDialog = new ProgressDialog(this);
	        prgDialog.setMessage("Buying. Please wait...");
	        prgDialog.setCancelable(false);
		  et = (EditText) findViewById(R.id.editText1);
		spinnerAccounts = (Spinner) this.findViewById(R.id.spinnerAccounts);
		SpinQunt = (Spinner) this.findViewById(R.id.SpinQunt);
		...
		not = (TextView) this.findViewById(R.id.not);
		 ...
		 SpinQunt.setOnItemSelectedListener(new OnItemSelectedListener(){

				@Override
				public void onItemSelected(AdapterView<?> parent, View view, int position,
						long id) {
					// TODO Auto-generated method stub
					String no =parent.getItemAtPosition(position).toString();
					editTransAmount.setText(no);
         ...
         Cursor c = db.getAccId(prod);
			int j = 0;
		       accountId = c.getString(j);
				...
				SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(AddBuy.this);
				...
				if(editChequeNo.getText().toString().equals(""))
				{
					Toast.makeText(getApplicationContext(), "Please enter buying price", Toast.LENGTH_LONG).show();
					return;
				}
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		SharedPreferences ct = PreferenceManager
				.getDefaultSharedPreferences(AddBuy.this);
		Editor edit = ct.edit();
	...
	private void DataFromDB() {
		 SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(AddBuy.this);
	        String username = prefs.getString("user", "anon");
		dbHelper=new DBHelper(AddBuy.this);
		...
		adapter=new ArrayAdapter<String>(AddBuy.this,android.R.layout.simple_list_item_1,dbdata);
		...
		spinnerAccounts.setAdapter(new ArrayAdapter<String>(AddBuy.this, android.R.layout.simple_spinner_dropdown_item,array_sort));
