...
public class UpdatePass extends Activity {
	...
	private EditText editPass, editCpass;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		editCpass = (EditText) this.findViewById(R.id.editCpass);
		
		
		 
		prgDialog = new ProgressDialog(this);
		prgDialog.setMessage("Updating Password. Please wait...");
	...
	public void onStart() {
		super.onStart();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(UpdatePass.this);
		...
		if (account.moveToFirst()) {
			// update view
			editPass.setText(account.getString(account
	...
	public void updateAccount(View v) {
		try {
			...
			String cpassword = editCpass.getText().toString();
            ...
            queryValues.put("pass", editPass.getText().toString());
      
         
        
			ContentValues values = new ContentValues();
			values.put( Database.PASSWORD, queryValues.get("pass"));
			...
			db.close();
			if (rows > 0){
				Toast.makeText(this, "Updated Password Successfully!",
			...
			editCpass.setText("");
				...
				Toast.makeText(this, "Sorry! Could not update Password!",
						Toast.LENGTH_LONG).show();}
		} catch (Exception ex) {
