...
public class Activity_ListExpense extends DashBoardActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listexpense);
		...
		listStock.setOnItemClickListener( new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View selectedView, int arg2,long arg3) {
				...
				Intent intent = new Intent(Activity_ListExpense.this, UpdateExpense.class);
    ...
    public void addExpenses(){
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Activity_ListExpense.this);
        String username = prefs.getString("user", "anon");
		DBHelper db = new DBHelper(getApplicationContext());
		int expense = db.totalExpense(username);
	...
	public void onStart() {
		...
		try {
			...
			Cursor  accounts = db.query( false, Database.EXPENSE_TABLE_NAME,null, "uid" + "='" + username + "'",null,null,null,null,null,null);
			
			String from [] = { Database.EXPENSE_ID , Database.EXPENSE_NAME,  Database.EXPENSE_AMOUNT ,  Database.EXPENSE_DATE};
